...
from .views import VhomeView, VregisterView, VmyView, VdetailView, VlistView, VdeleteView, VlistdeleteView, VtogglemyView, VtogglelistView, VapprovalView, VpassView, VcheckinView, VcheckoutView, VmyexcelView, VallexcelView
